...
$queryTrajets = $db->prepare("
    ...
    left join TRAJET_UTILISATEUR on TRAJET.id_trajet = TRAJET_UTILISATEUR.id_trajet
    where TRAJET_UTILISATEUR.id_utilisateur = '".$id_utilisateur."'
    and TRAJET_UTILISATEUR.conducteur = '1'
